public class MoreRecursionHelper {
    ...
    public void combinations(String str, int index, String currStr) {
        ...
        // Recursive case: include the character at the current index in the combination
        combinations(str, index + 1, currStr + str.charAt(index));

        // Recursive case: exclude the character at the current index from the combination
